...
const COPY = {
  zh: { tagline: "保护期康复 · 非医疗诊断", title: "腰护打卡", pain: "躺着腿痛 0–10", walk: "一次能走（分钟）", guide: "动作指导和注意", poseHint: "对照图片做，痛就减小幅度", safety: "安全停", safetyBody: "力弱、会阴麻、小便变差：停练并联系医生。", export: "复制记录到剪贴板", reset: "重置今天", resetConfirm: "清空今天打卡？", copied: "已复制", pain7: "近 7 天躺着痛分", noRecord: "无记录", notes: "我的情况（可改）", notesHint: "数据只存在本机微信。不能代替医嘱。", about: "腰椎保护期打卡工具。" },
  en: { tagline: "Protection-phase rehab", title: "Spine Check-in", pain: "Leg pain at rest 0-10", walk: "Walk minutes", guide: "How to do it", poseHint: "Match the photo.", safety: "Stop if", safetyBody: "Weakness, saddle numbness, or bladder change: stop and call a doctor.", export: "Copy records", reset: "Reset today", resetConfirm: "Clear today's check-in?", copied: "Copied", pain7: "Resting pain, last 7 days", noRecord: "No record", notes: "My situation", notesHint: "Stored on this phone only.", about: "Lumbar protection-phase check-in tool." }
};
